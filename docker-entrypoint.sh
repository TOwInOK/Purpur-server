...
exec gosu $DOCKER_USER:$DOCKER_GROUP java --add-modules=jdk.incubator.vector -jar -Xms$MEMORYSIZE -Xmx$MEMORYSIZE $JAVAFLAGS /opt/minecraft/purpur.jar $ADD_FLAGS nogui
