...
exec gosu $DOCKER_USER:$DOCKER_GROUP java $OVERRIDEFLAGS $PUFFERFISHFLAGS -jar -Xms$MEMORYSIZE -Xmx$MEMORYSIZE $JAVAFLAGS /opt/minecraft/purpur.jar $SPIGOT_FLAGS $PAPERMC_FLAGS $PURPUR_FLAGS nogui
